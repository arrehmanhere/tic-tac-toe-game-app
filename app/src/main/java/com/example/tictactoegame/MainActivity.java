    ...
    private void performAction (ImageView imageView,int selectedBoxPosition){
        ...
        if(playerTurn==1){
            ...
            if(checkPlayerWin()){
                ...
                WinDialouge winDialouge = new WinDialouge(MainActivity.this,playerOneName.getText().toString() + "has won!",MainActivity.this);
                winDialouge.setCancelable(false);
                winDialouge.show();
            }else if (totalSelectedBoxes == 9){
                WinDialouge winDialouge = new WinDialouge(MainActivity.this,"Draw!",MainActivity.this);
                winDialouge.setCancelable(false);
                winDialouge.show();
            }else {
                changePlayerTurn(2);
            ...
            if(checkPlayerWin()){
                ...
                WinDialouge winDialouge = new WinDialouge(MainActivity.this,playerTwoName.getText().toString() + " has won!",MainActivity.this);
                winDialouge.setCancelable(false);
                winDialouge.show();

            }else if(selectedBoxPosition==9){

                WinDialouge winDialouge = new WinDialouge(MainActivity.this,"Match Draw!",MainActivity.this);
                winDialouge.setCancelable(false);
                winDialouge.show();
